...
// };
    notes = {
        // 1. Never Gonna Give You Up (Full Chorus)
        {
            0, 1, 3, 1, 4, 4, 3,       // Never gonna give you up
            0, 1, 3, 1, 3, 4, 2, 1, 0, // Never gonna let you down
            0, 1, 3, 1, 5, 5, 4,       // Never gonna run around and desert you
            0, 1, 3, 1, 4, 3, 2, 1, 0  // Never gonna make you cry...
        },
        // 2. All Star (Full Chorus)
        {
            4, 6, 5, 4, 7, 6, 5, 4, 6, 5, 4, 3, 4, // Hey now, you're an all star, get your game on, go play
            4, 6, 5, 4, 7, 6, 5, 4, 6, 5, 4, 3, 4, // Hey now, you're a rock star, get the show on, get paid
            3, 3, 3, 3, 2, 0, 0,                   // And all that glitters is gold
            2, 2, 1, 1, 0, 1, 0                    // Only shooting stars break the mold
        },
        // 3. We Will Rock You (Full Chorus x 4 to match standard song length)
        {
            2, 2, 1, 1, 2,  // We will we will rock you
            2, 2, 1, 1, 2,  // We will we will rock you
            2, 2, 1, 1, 2,  // We will we will rock you
            2, 2, 1, 1, 2   // We will we will rock you
        },
        // 4. Let It Be (Full Chorus)
        {
            4, 5, 4, 2, 4, 5, 4, 2, // Let it be, let it be, let it be, let it be
            2, 2, 1, 0, 1, 0, 0,    // Whisper words of wisdom, let it be
            4, 5, 4, 2, 4, 5, 4, 2, // Let it be, let it be, let it be, let it be
            2, 2, 1, 0, 1, 0, 0     // Whisper words of wisdom, let it be
        },
        // 5. Take On Me (Full Chorus)
        {
            5, 6, 7,          // Take on me
            5, 6, 7,          // Take me on
            5, 4, 3, 4,       // I'll be gone
            5, 4, 3, 4, 5, 2  // In a day or two
        },
        // 6. Sweet Caroline (Full Chorus)
        {
            0, 3, 4,                // Sweet Caroline
            4, 5, 6,                // Ba ba ba
            7, 7, 6, 5, 4, 3, 4,    // Good times never seemed so good
            0, 3, 4,                // I've been inclined
            7, 7, 6, 5, 4, 3, 2     // To believe they never would
        },
        // 7. Don't Stop Believin' (Full Chorus)
        {
            2, 2, 2, 3, 2, 0, // Don't stop believin'
            2, 2, 2, 3, 2, 1, // Hold on to that feelin'
            0, 2, 4, 5,       // Streetlight, people
            4, 3, 2           // Oh, oh, oh
        },
        // 8. Livin' On A Prayer (Full Chorus)
        {
            4, 4, 5, 6, 6,          // Woah, we're half way there
            4, 4, 2, 1, 2,          // Woah, livin' on a prayer
            4, 4, 5, 6, 6, 5, 4, 5, // Take my hand, we'll make it I swear
            4, 4, 2, 1, 2           // Woah, livin' on a prayer
        },
        // 9. I Want It That Way (Full Chorus)
        {
            4, 5, 6,                // Tell me why
            6, 6, 6, 6, 5, 4, 5,    // Ain't nothin' but a heartache
            4, 5, 6,                // Tell me why
            6, 6, 6, 6, 5, 4, 5,    // Ain't nothin' but a mistake
            4, 5, 6,                // Tell me why
            6, 6, 6, 5, 4, 3, 2,    // I never wanna hear you say
            2, 3, 4, 4, 4           // I want it that way
        },
        // 10. I Gotta Feeling (Full Chorus)
        {
            4, 4, 4, 7,                // I gotta feeling
            7, 6, 5, 4, 4, 4, 5, 6,    // That tonight's gonna be a good night
            7, 6, 5, 4, 4, 4, 5, 6,    // That tonight's gonna be a good night
            7, 6, 5, 4, 4, 4, 5, 4, 2  // That tonight's gonna be a good, good night
        }
    };
    durations = {
        // 1. Never Gonna Give You Up
        {
            25, 25, 25, 25, 50, 50, 100,
            25, 25, 25, 25, 50, 50, 50, 25, 100,
            25, 25, 25, 25, 50, 50, 100,
            25, 25, 25, 25, 50, 50, 50, 25, 100
        },
        // 2. All Star
